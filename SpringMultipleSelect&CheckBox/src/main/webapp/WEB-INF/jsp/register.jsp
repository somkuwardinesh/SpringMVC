...
<body>
	...
	<form:form id="student" name="student" method="post" commandName="student"
		...
		<fieldset>
			...
			<div class="form-group">
				<form:label path="movies" class="col-md-4 control-label"
					for="textinput">MovieName</form:label>
				<div class="col-md-4">
						<form:checkboxes items="${mmap}" path="movies"/>
				</div>
			</div>

			 <div class="form-group">
				<form:label path="course" class="col-md-4 control-label"
					for="textinput">CourseName</form:label>
				<div class="col-md-4">
						<form:select path="course" id="course" name="course" class="form-control" multiple="true">
